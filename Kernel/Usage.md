...
* `#!wl multiGammaPoleAnalysis` - analyse the poles of specified variables from a product of Gamma factors.

* `#!wl $multiGammaPoleAnalysisNewSymbolHead` - head of new symbol generated by gammaPoleAnalysis.