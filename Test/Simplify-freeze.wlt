...
VerificationTest[
    fixTempSymbol[res_] := Module[{tempSymbolList, i = 0}, tempSymbolList = DeleteDuplicates[Cases[res, var_Symbol /; StringStartsQ[ToString[var, InputForm], "sub$"], All]]; (ReplaceAll[(#1 -> (i++; C[i]) & ) /@ tempSymbolList])[res]]; 
    ,
    Null
    ,
