...
VerificationTest[
    (label[x, 1, #1] & ) /@ {Symbol, Construct, Subscript, Superscript}
    ,
...
VerificationTest[
    (label[x, {1, 2}, #1] & ) /@ {Symbol, Construct, Subscript, Superscript}
    ,
...
VerificationTest[
    (label[{x, y}, 1, #1] & ) /@ {Symbol, Construct, Subscript, Superscript}
    ,
...
VerificationTest[
    (label[{x, y}, {1, 2}, #1] & ) /@ {Symbol, Construct, Subscript, Superscript}
    ,
...
VerificationTest[
    (label[x, Null, #1] & ) /@ {Symbol, Construct, Subscript, Superscript}
    ,
    {x, x, x, x}
    ,
    TestID->"6-Label.nb"
...
VerificationTest[
    ...
    ,
    Quiet[MatrixForm[{{{Symbol, Symbol} -> HoldComplete[{x1, x[1], Subscript[x, 1], Superscript[x, 1]}], {Symbol, Construct} -> {x[1], x[1], Subscript[x, 1], Superscript[x, 1]}, {Symbol, Subscript} -> {Subscript[x, 1], x[1], Subscript[x, 1], Superscript[x, 1]}, {Symbol, Superscript} -> {Superscript[x, 1], x[1], Subscript[x, 1], Superscript[x, 1]}}, {{Construct, Symbol} -> {x1, x1, Subscript[x, 1], Superscript[x, 1]}, {Construct, Construct} -> HoldComplete[{x1, x[1], Subscript[x, 1], Superscript[x, 1]}], {Construct, Subscript} -> {x1, Subscript[x, 1], Subscript[x, 1], Superscript[x, 1]}, {Construct, Superscript} -> {x1, Superscript[x, 1], Subscript[x, 1], Superscript[x, 1]}}, {{Subscript, Symbol} -> {x1, x[1], x1, Superscript[x, 1]}, {Subscript, Construct} -> {x1, x[1], x[1], Superscript[x, 1]}, {Subscript, Subscript} -> HoldComplete[{x1, x[1], Subscript[x, 1], Superscript[x, 1]}], {Subscript, Superscript} -> {x1, x[1], Superscript[x, 1], Superscript[x, 1]}}, {{Superscript, Symbol} -> {x1, x[1], Subscript[x, 1], x1}, {Superscript, Construct} -> {x1, x[1], Subscript[x, 1], x[1]}, {Superscript, Subscript} -> {x1, x[1], Subscript[x, 1], Subscript[x, 1]}, {Superscript, Superscript} -> HoldComplete[{x1, x[1], Subscript[x, 1], Superscript[x, 1]}]}}]]
    ,
...
VerificationTest[
    (labelToZero[{z, zb}, {1, 2}, #1] & ) /@ {Symbol, Construct, Subscript, Superscript}
    ,
...
VerificationTest[
    (labelToEqual[{z, zb}, {1 -> 2}, #1] & ) /@ {Symbol, Construct, Subscript, Superscript}
    ,
...
VerificationTest[
    (labelToDiff[{z, zb}, {1 -> 2}, #1] & ) /@ {Symbol, Construct, Subscript, Superscript}
    ,
...
VerificationTest[
    (labelToDiffZero[{z, zb}, {1 -> 2}, #1] & ) /@ {Symbol, Construct, Subscript, Superscript}
    ,
...
VerificationTest[
    (labelToDiffBack[{z, zb}, {1 -> 2}, #1] & ) /@ {Symbol, Construct, Subscript, Superscript}
    ,
